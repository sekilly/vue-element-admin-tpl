...
<div class="page-body">
  ...
  <div class="box">
    <el-form :inline="true" :model="org"  v-show="searchShow">
      <el-form-item label="表名：">
        <el-input v-model="org.name"></el-input>
      </el-form-item>
      <el-form-item label="描述：">
        <el-input v-model="org.comments"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      list () {
        ...
        this.$http.get(this.global.serverPath + 'org', {params: this.org}, {emulateJSON: true})
          .then((response) => {
      ...
      del (id) {
        ...
        this.$http.delete(this.global.serverPath + 'gen/org', {params: {'id': id}}, {emulateJSON: true})
          .then((response) => {
            this.list()
      ...
      getById (id) {
        ...
        this.$http.get(this.global.serverPath + 'gen/org/' + id)
          .then((response) => {
            // this.$message(response.msg)
          }, (response) => {
            console.log('error ==== ' + response)
